...
@section('container')
    ...
    <section id="gallery" class="pt-32 pb-5">
      <h1 class="title-section">Gallery <span class="text-sky-500 font-outline-0">Kami</span></h1>
      <h1 class=" text-center text-neutral-500 text-sm mt-2">Foto-foto kami ketika melakukan kegiatan di kampus.
      </h1>
      <div class="p-5 sm:p-8">
          <div
              class="columns-1 gap-5 sm:columns-2 sm:gap-8 md:columns-3 lg:columns-4 [&>img:not(:first-child)]:mt-8 flex flex-wrap lg:block lg:flex-nowrap justify-center">
              @foreach ($galleries as $gallery)
              <img class="object-scale-down" id="gallery-img" src="{{ asset('storage/' . $gallery->image) }}" fetchpriotity="low" width="300"
                  height="300" data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out"
