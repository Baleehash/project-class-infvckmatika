...
<div class="px-6 pt-6 2xl:container">
  <h1 class="text-3xl font-semibold text-sky-800 py-3">Member Section</h1>
  <hr class=""></div>
    ...
    <div class="flex py-3 ">
        ...
        <div class="flex pb-5">
            <div class="flex justify-start -ml-2 pt-1">
                <a href="/dashboard/members/create" class="block bg-emerald-500 p-2 rounded-md text-white">+ Tambah Member Baru</a>
            </div>
            <div class="flex flex-row ml-2 pt-1">
                <a href="/members" class="block bg-teal-500 p-2 rounded-md text-white">Halaman Member </a>
            </div>
        </div>
                ...
                <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-sky-950">
                            <tr>
                                <th scope="col" class="px-4 py-3.5 text-sm border-e border-neutral-200  dark:border-white/10 font-normal text-left rtl:text-right text-white dark:text-white">
                                    No
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium border-e border-neutral-200  dark:border-white/10 text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        <span>{{ $loop->iteration }}</span>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm text-gray-500 border-e border-neutral-200  dark:border-white/10 dark:text-gray-300 ">
                                    <img src="{{ asset('storage/' . $member->image) }}" class="w-1/2">
                                </td>
                                <td class="px-4 py-4 text-sm font-medium border-e border-neutral-200  dark:border-white/10 text-gray-700 ">
                                    <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-neutral-400">
                                        <h2 class="text-lg font-normal">{{ $member->member }}</h2>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm font-medium border-e border-neutral-200  dark:border-white/10 text-gray-700 ">
                                    <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-neutral-400">
                                        <h2 class="text-lg font-normal">{!! $member->nickname !!}</h2>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm font-medium border-e border-neutral-200  dark:border-white/10 text-gray-700 ">
                                    <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-neutral-400">
                                        <h2 class="text-lg font-normal">{!! $member->quotes !!}</h2>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm">
                                    <div class="flex items-center gap-x-6"> 
                                        {{-- Eye --}}
                                        <a href="/dashboard/members/{{ $member->id }}" class="bg-sky-500 p-2  rounded-xl">
