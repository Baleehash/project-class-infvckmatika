...
<div class="px-6 pt-6 2xl:container">
  <h1 class="text-3xl font-semibold text-sky-800 py-3">Gallery Section</h1>
  <hr class=""></div>
    ...
    <div class="flex py-3 ">
        ...
        <div class="flex pb-5">
            <div class="flex justify-start -ml-2 pt-1">
                <a href="/dashboard/galleries/create" class="block bg-emerald-500 p-2 rounded-md text-white">+ Tambah Gallery Baru</a>
            </div>
            <div class="flex flex-row ml-2 pt-1">
                <a href="/gallery" class="block bg-teal-500 p-2 rounded-md text-white">Halaman Gallery </a>
            </div>
        </div>
                ...
                <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            ...
                            <tr>
                                <td class="px-3 py-4 text-sm border-e border-neutral-200  dark:border-white/10 font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        <span>{{ $loop->iteration }}</span>
                                    </div>
                                </td>
                                <td class="flex justify-center px-3 py-4 text-sm border-e border-neutral-200  dark:border-white/10 text-gray-500 dark:text-gray-300 ">
                                    <img src="{{ asset('storage/' . $gallery->image) }}" class="w-64">
                                </td>
                                <td class=" py-4 text-sm border-e border-neutral-200  dark:border-white/10 font-medium text-gray-700 ">
                                    <div class="inline-flex items-center py-1 px-4 rounded-full gap-x-2 text-neutral-400">
                                        <h2 class="text-lg font-normal">{{ $gallery->alt }}</h2>
                                    </div>
                                </td>
                                ...
                                <td class="px-8 py-4 text-sm border-e border-neutral-200  dark:border-white/10">
                                    <div class="flex items-center flex-col gap-2"> 
                                        {{-- Eye --}}
                                        <a href="/dashboard/galleries/{{ $gallery->id }}" class="bg-sky-500 p-2  rounded-xl"> 
