...
@section('container')
        ...
        <div class="container mx-auto md:mx-auto md:px-4 lg:mx-auto">
            ...
            <div class="flex flex-wrap text-center lg:text-left">
                <div class="w-full self-start px-4 mb-10 lg:mb-0 lg:w-1/2">
                    <div class="flex flex-wrap ml-5 justify-center md:ml-44 md:justify-center lg:ml-0 lg:justify-start gap-2 font-normal text-xl lg:text-2xl md:text-xl [text-wrap:balance] bg-clip-text text-transparent bg-sky-950 text-center"
                        id="hero-text">
                        Ketika Kami <span
                            class="text-sky-500 inline-flex flex-col h-[calc(theme(fontSize.3xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.4xl)*theme(lineHeight.tight))] overflow-hidden">
                            <ul
                                class="block animate-text-slide-5 leading-[2.40rem] [&_li]:block font-semibold text-center md:text-left lg:text-left">
                                <li>Tobat <span class="font-outline-1 text-transparent">jadi</span> Insaf<span
                                        class="font-outline-1 text-transparent">matika</span></li>
                                <li>Sedekah <span class="font-outline-1 text-transparent">jadi</span> Infaq<span
                                        class="font-outline-1 text-transparent">matika</span></li>
                                <li>Kuliah <span class="font-outline-1 text-transparent">jadi</span> Infor<span
                                        class="font-outline-1 text-transparent">matika</span></li>
                                <li>Ngoding <span class="font-outline-1 text-transparent">jadi</span> Pusing<span
                                        class="font-outline-1 text-transparent"></span></li>
                                <li>Ngoding Lagi <span class="font-outline-1 text-transparent">jadi</span> Lebih
                                    Pusing<span class="font-outline-1 text-transparent"></span></li>
                                <li>Tobat <span class="font-outline-1 text-transparent">jadi</span> Insaf<span
                                        class="font-outline-1 text-transparent">matika</span></li>
                            </ul>
                        </span></div>
                    ...
                    <div class="flex justify-center lg:justify-start" id="hero-text">
                        <div class="w-40 h-12 bg-sky-800 hover:bg-sky-900 flex justify-center">
                            <a href="#about" class="flex text-white justify-center items-center text-sm">Jelajahi Kelas
    ...
    <section id="about" class="pt-28">
        <h1 class="title-section" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out"
            data-aos-offset="200" data-aos-once="true">Tentang
            <span class="text-sky-500 font-outline-0">Kami</span>
        </h1>
        <div class="container mx-auto md:mx-auto md:px-4 lg:mx-auto ">
            <div class="flex flex-wrap">
                <div class=" flex justify-center items-start lg:w-1/2" data-aos="fade-right" data-aos-duration="1000"
                    data-aos-easing="ease-in-out" data-aos-offset="200" data-aos-once="true">
                    <img src="{{ asset('storage/' . $home->about_image) }}" class="flex w-11/12" alt="about" fetchpriotity="high"
                        width="200" height="200">
                </div>
                <div class="w-full lg:w-1/2 flex flex-col p-5 lg:pt-20" data-aos="fade-left" data-aos-duration="1000"
                    data-aos-easing="ease-in-out" data-aos-offset="200" data-aos-once="true">
                    <h1 class="text-3xl text-center lg:text-left lg:text-5xl font-semibold text-sky-500">
                        {{ $home->about_title }}
                    </h1>
                    <div class="text-neutral-500 pt-5 mb-5 text-center lg:text-justify">
                        <p class="">{!! $home->about_text !!} </p>
                    </div>
                    <div class="flex justify-center lg:justify-start pt-4">
                        <div class="w-40 h-12 bg-sky-800 hover:bg-sky-900 flex justify-center">
                            <a href="/members"
                                class="flex text-white justify-center items-center text-sm">Member
                                Kelas
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ml-2" width="24"
                                    height="24">
                                    <path
    ...
    <section id="project" class="pt-28">
        <h1 class="title-section" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out"
            data-aos-offset="200" data-aos-once="true">Project <span class="text-sky-500 font-outline-0">Kami</span>
        </h1>
        <p class=" text-center text-neutral-500 text-sm mt-2" data-aos="fade-up" data-aos-duration="1000"
            data-aos-easing="ease-in-out" data-aos-once="true">3 Project terbaik yang di buat
            oleh member member
            kami berdasarkan voting kelas !
        </p>
        <div class="container lg:p-3 mx-auto md:mx-auto md:px-4 lg:mx-auto">
            <div class="flex flex-wrap justify-center gap-5 lg:gap-0 lg:ml-20 items-start">
                ...
                @endif"
                    id="projects" 
                @if ($project->id == 1)
                    data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-offset="200"
                    data-aos-once="true"                
                @elseif ($project->id == 2)
                    data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-offset="200"
                    data-aos-once="true"                
                @else
                    data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-out" data-aos-offset="200"
                data-aos-once="true"                
                @endif>
                <img src="{{ asset('storage/' . $project->image) }}" class="flex w-10/12" alt="project"
                fetchpriotity="high" width="200" height="200">
                <div class="flex flex-col lg:text-left text-center gap-1">
    ...
    <!-- The Project Section END -->
    

    <!-- The Gallery Section START -->
    <section id="gallery" class="pt-28 pb-5 items-start">
        <h1 class="title-section" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out"
            data-aos-offset="200" data-aos-once="true">Gallery <span class="text-sky-500 font-outline-0">Kami</span>
        </h1>
        <!-- <h1 class=" text-center text-neutral-500 text-sm mt-2" data-aos="fade-up" data-aos-duration="1000"
            data-aos-easing="ease-in-out" data-aos-offset="200" data-aos-once="true">Foto-foto kami ketika melakukan
            kegiatan di kampus.
        </h1> -->
        <div class="flex flex-col justify-center items-center pt-10">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide bg-center bg-cover items-start pl-0 lg:pl-64 w-full lg:w-1/2 flex justify-center">
                        @if($gallery->alt == 'Landscape')
                        <img src="{{ asset('storage/' . $gallery->image) }}" class=" bg-center bg-cover items-start w-full lg:w-3/4 flex justify-center" fetchpriotity="low"
                            width="400" height="400" lazy="load" />
                        @endif
                    </div>
                    @endforeach
                </div>
